...
export function mountMapControls(host: MapControlHost): {
  ...
  const el = h("div", { class: "map-ctl", "data-band": "chrome" }, goto, nudgeHome, invHome, offer, modeBanner, statusHome, topright, layers, paneMenu, moreMenu, zoom);
  ...
  return { el, viewMoved, syncLayers, syncMeasure, syncResearch, syncActive, tuningChanged };
}
