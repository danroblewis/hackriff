...
export interface OverlayQuad {
   ...
   * energy, hatched between two edges, never a signal's box; the remaining two are the map's own.
   * All are strokes, and `overlay.ts` can draw nothing else. */
  readonly kind: "pane-outline" | "live-segment" | "signal-box" | "selection-box" | "measurement-box" | "annotation" | "research-box" | "pending-region" | "trace-slice" | "trace-hold" | "time-rule" | "hud-tick" | "artifact-link" | "path-stroke" | "prior-band" | "density-cell" | "frontend-event";
