...
export interface OverlayQuad {
  ...
  readonly kind: "pane-outline" | "live-segment" | "signal-box" | "selection-box" | "measurement-box" | "research-box" | "pending-region" | "trace-slice" | "trace-hold" | "time-rule" | "hud-tick";
