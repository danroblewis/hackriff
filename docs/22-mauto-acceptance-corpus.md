...
| **P9** | LoRa/CSS ISM burst | have | SF/BW/CR/payload | out-of-catalogue today | calibrated-leaning | **report only** (§7); asserted only as "never `solved`", which is its N3 role | 3 seeds |
