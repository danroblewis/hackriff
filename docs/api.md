...
`{id ("a<n>"), href, state, end_reason, error, target, profile, source, live_s, attach, templates, window, channel, budget, used, progress, results, trace_summary, replay_key, resolution, emitter_id, confirm, content_class, created, started, ended, warnings}`:
