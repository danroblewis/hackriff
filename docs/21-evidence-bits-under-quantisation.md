...
1. **Nothing changes without an explicit amendment.** `min_analytic_holdout_bits = 24`,
   `hard_check_floor_bits = 16`, `min_check_width = 16` (T-577, measured; 8 only once ADR-0022
   §4.3.1's count is re-measured by T-577's harness, never below 8) and §4.2's formula all stand;
