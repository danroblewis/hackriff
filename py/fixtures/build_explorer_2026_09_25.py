...
~04:00-04:58 PDT, SF; the P25 capture ~06:19 PDT the same session) and the explorer's own
...
endpoint, so unlike the earlier FM/RDS and P25 clips their source ``.sigmf-meta`` carries no
