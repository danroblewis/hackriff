...
(AWARE-042), ``fm_broadcast_rds`` (SIGNAL-062), ``adsb_squitter`` (SIGNAL-001). Every scenario also
accepts the impairment parameters in :data:`hkpy.synth.impairments.IMPAIRMENT_DEFAULTS`.
